...
export interface Config {
  ...
  collectionsSelect: {
    ...
    tacticals: TacticalsSelect<false> | TacticalsSelect<true>;
...
export interface Tactical {
  ...
  relatedPosts?: (number | Tactical)[] | null;
  categories?: (number | Category)[] | null;
  meta?: {
    title?: string | null;
    /**
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "tacticals_select".
 */
